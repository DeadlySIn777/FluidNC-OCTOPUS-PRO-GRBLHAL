...
#elif defined(BOARD_BTT_OCTOPUS_PRO_MR1)
  #include "boards/btt_octopus_pro_mr1_map.h"
#elif defined(BOARD_BTT_OCTOPUS_PRO_F429)
  #include "boards/btt_octopus_pro_map.h"
#elif defined(BOARD_BTT_OCTOPUS_PRO_SLOTS345)
  #include "boards/btt_octopus_pro_slots345_map.h"
