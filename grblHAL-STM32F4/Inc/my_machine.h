...
//#define SPINDLE0_ENABLE         SPINDLE_MODVFD  // Generic Modbus VFD (for Veikong, etc) - DISABLED FOR TESTING
#define SPINDLE0_ENABLE         SPINDLE_PWM0_NODIR  // Simple PWM spindle, no direction
...
// **********************
//#define MODBUS_ENABLE           3 // Set to 3 for RTU + direction signal (0b011 = RTU_ENABLED | RTU_DIR_ENABLED) - DISABLED
//#define VFD_SPINDLE             1 // Enable VFD spindle support - DISABLED
...
#define TRINAMIC_ENABLE      2209 // Trinamic TMC2209 stepper driver support - ENABLED!
//#define TRINAMIC_ENABLE      2660 // Trinamic TMC2660 stepper driver support.
#define TRINAMIC_R_SENSE      110 // R sense resistance in milliohms, BTT TMC2209 uses 110mΩ
//#define TRINAMIC_I2C            1 // Trinamic I2C - SPI bridge interface.
#define TRINAMIC_DEV            1 // Development mode, adds M-codes to aid debugging
...
#define PROBE_ENABLE            0 // Disabled - probe input is floating and causes phantom triggers
