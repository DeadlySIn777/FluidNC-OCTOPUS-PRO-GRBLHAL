...
static void SystemClock_Config (void)
{
  __HAL_RCC_PWR_CLK_ENABLE();
   ...
   #if defined(BOARD_BTT_OCTOPUS_PRO) || defined(BOARD_BTT_OCTOPUS_PRO_F429)
   ...
   #if defined(BOARD_BTT_OCTOPUS_PRO) || defined(BOARD_BTT_OCTOPUS_PRO_F429) || defined(BOARD_BTT_OCTOPUS_PRO_MR1)

    // Bootloader does not clean up after itself - switch to HSI first
