...
const CACHE_NAME = 'fluidcnc-v15';
const STATIC_CACHE = 'fluidcnc-static-v15';
const DYNAMIC_CACHE = 'fluidcnc-dynamic-v15';
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing FluidCNC v14');
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activating FluidCNC v14');
...
self.addEventListener('fetch', (event) => {
    ...
    if (isStaticAsset(url)) {
        ...
        // API calls: Network Only (don't cache machine communication)
...
self.addEventListener('message', (event) => {
    ...
    if (event.data.type === 'GET_VERSION') {
        event.ports[0].postMessage({ version: 'v14', cache: STATIC_CACHE });
    }
